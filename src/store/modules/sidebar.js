  ...
  state: {
    sidebarItems: [
      ...
      },
      {
        ...
        icon: '<use xlink:href="/img/sprites.35d4d5b2.svg#new-user"></use>',
        isSelected: false,
        isClickable: true,
      },
      {
        name: 'Pagar débitos',
        icon: '<use xlink:href="/img/sprites.35d4d5b2.svg#give-money"></use>',
        isSelected: false,
        isClickable: false,
      },
      {
        name: 'Gerencial',
        icon: '<use xlink:href="/img/sprites.35d4d5b2.svg#line-chart"></use>',
        subItems: [
          'Ver devedores',
